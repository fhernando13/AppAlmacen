...
const routes: Routes = [
  ...
  { path: 'formProducto',   canActivate:[authGuard, adminGuard], component: ProductoFormComponent },
  { path: 'updateProducto/:Idproducto',  canActivate:[authGuard, adminGuard], component: ProductoUpdaComponent },
