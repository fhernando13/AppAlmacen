...
INSERT INTO almacen.Productos (Idproducto, Nombreproducto, Precioproducto,EstatusProducto,ExistenciaProducto) VALUES(0, 'laptop', 3000.00,1,0),
																													(0, 'pc', 4000.00,1,0),
																													(0, 'mouse', 100.00,1,0),
																													(0, 'teclado', 150.00,1,0),
																													(0, 'monitor', 2000.00,1,0),
																													(0, 'microfono', 350.00,1,0),
																													(0, 'audifonos', 450.00,1,0);
...
INSERT INTO almacen.Inventarios (Idinventario, FechaInventario, Cantidad, UsuarioId, ProductoId, MovimientoId)VALUES (0, '2024-12-12', 8, 3, 5, 2),
																													 (0, '2024-12-12', 15, 2, 1, 2),
																													 (0, '2024-12-12', 13, 4, 6, 2),
																													 (0, '2024-12-12', 4, 3, 6, 2),
																													 (0, '2024-12-12', 3, 2, 2, 2),
																													 (0, '2024-12-12', 1, 4, 5, 2),
																													 (0, '2024-12-12', 5, 2, 4, 2),
																													 (0, '2024-12-12', 5, 3, 2, 2),
																													 (0, '2024-12-12', 2, 3, 6, 2),
																													 (0, '2024-12-12', 8, 4, 1, 2);
